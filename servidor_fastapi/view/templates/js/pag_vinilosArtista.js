document.addEventListener("DOMContentLoaded", () => {
    const contenedor   = document.getElementById("contenedor-productos-artista");
    const filtroOrden  = document.getElementById("ordenar-artista");
    const botonesFiltro = document.querySelectorAll(".filter-btn");
    const pagContainer = document.getElementById("paginacion-artista");
    const porPagina    = 5;
